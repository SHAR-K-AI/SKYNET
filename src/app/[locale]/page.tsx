...
export default function MainPage() {
    ...
    return (
        <div
            className="min-h-screen text-gray-900 dark:text-gray-100 relative transition-colors duration-500">
            <AnimatePresence>
                {showModal && (
                    <motion.div
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <h2 className="text-2xl font-semibold text-blue-700 dark:text-blue-300 mb-2">{t("whatYouWillFind")}</h2>
