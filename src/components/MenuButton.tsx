    ...
    return (
        <SoundWrapper playOn="click">
            <button
                ...
                className="w-14 h-14 fixed top-10 rounded-full bg-blue-500 dark:bg-blue-700 hover:bg-yellow-500  flex items-center justify-center shadow-lg cursor-pointer"
            >
                <motion.span
